...
<aside id="default-sidebar"
    class="fixed top-[4.15rem] left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-white shadow dark:bg-gray-800">
