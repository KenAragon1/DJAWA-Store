    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 bg-white border rounded-lg dark:border-gray-700">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full overflow-x-auto divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        @for ($i = 0; $i < 10; $i++)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">Aragon
                                </td>
